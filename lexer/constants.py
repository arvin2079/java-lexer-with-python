...
S_Int, S_Double, S_Float, S_String, S_Boolean, S_Byte, S_Long, S_Short, S_Char, \
S_Lbrace, S_Rbrace, S_Lparen, S_Rparen, S_Semi, S_Comma, S_Identifier = range(73)

""" single character only symbols """
symbols = {'{': S_Lbrace, '}': S_Rbrace, '(': S_Lparen, ')': S_Rparen, ';': S_Semi, ',': S_Comma}
...
""" symbol values """
symbol_values = ['end_of_file', 'op_add', 'op_sub', 'op_mul', 'op_div', 'op_mod', 'op_increment', 'op_decrement', 'op_equal',
